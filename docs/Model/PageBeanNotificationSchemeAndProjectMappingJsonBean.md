...
**values** | [**\OpenAPI\Client\Model\NotificationSchemeAndProjectMappingJsonBean[]**](NotificationSchemeAndProjectMappingJsonBean.md) | The list of items. | [optional] [readonly]
