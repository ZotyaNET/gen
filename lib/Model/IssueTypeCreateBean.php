...
/**
 * IssueTypeCreateBean Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IssueTypeCreateBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTypeCreateBean';
    ...
    */
     ...
     *
     * @param int|null $hierarchy_level The hierarchy level of the issue type. Use:   *  `-1` for Subtask.  *  `0` for Base.  Defaults to `0`.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name The unique name for the issue type. The maximum length is 60 characters.
     *
     * @return self
     */
