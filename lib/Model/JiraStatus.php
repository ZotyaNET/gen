 ...
 */
class JiraStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JiraStatus';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'name' => 'string',
        'scope' => '\OpenAPI\Client\Model\StatusScope',
        'status_category' => 'string',
        'usages' => '\OpenAPI\Client\Model\ProjectIssueTypes[]',
        'workflow_usages' => '\OpenAPI\Client\Model\WorkflowUsages[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'usages' => 'usages',
        'workflow_usages' => 'workflowUsages'
    ];
    ...
    protected static $setters = [
        ...
        'usages' => 'setUsages',
        'workflow_usages' => 'setWorkflowUsages'
    ];
    ...
    protected static $getters = [
        ...
        'usages' => 'getUsages',
        'workflow_usages' => 'getWorkflowUsages'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('workflow_usages', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets scope
     *
     * @return \OpenAPI\Client\Model\StatusScope|null
     */
     ...
     * Sets scope
     *
     * @param \OpenAPI\Client\Model\StatusScope|null $scope scope
     *
     * @return self
     */
     ...
     * Sets usages
     *
     * @param \OpenAPI\Client\Model\ProjectIssueTypes[]|null $usages Projects and issue types where the status is used. Only available if the `usages` expand is requested.
     *
     * @return self
     */
    ...
    /**
     * Gets workflow_usages
     *
     * @return \OpenAPI\Client\Model\WorkflowUsages[]|null
     */
    public function getWorkflowUsages()
    {
        return $this->container['workflow_usages'];
    }

    /**
     * Sets workflow_usages
     *
     * @param \OpenAPI\Client\Model\WorkflowUsages[]|null $workflow_usages The workflows that use this status. Only available if the `workflowUsages` expand is requested.
     *
     * @return self
     */
    public function setWorkflowUsages($workflow_usages)
    {



        if (is_null($workflow_usages)) {
            throw new \InvalidArgumentException('non-nullable workflow_usages cannot be null');
        }

        $this->container['workflow_usages'] = $workflow_usages;
