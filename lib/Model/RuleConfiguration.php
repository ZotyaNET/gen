...
class RuleConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets tag
     *
     * @param string|null $tag A tag used to filter rules in [Get workflow transition rule configurations](https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-workflow-transition-rules/#api-rest-api-3-workflow-rule-config-get).
     *
     * @return self
     */
    public function setTag($tag)
    {
        if (!is_null($tag) && (mb_strlen($tag) > 255)) {
            throw new \InvalidArgumentException('invalid length for $tag when calling RuleConfiguration., must be smaller than or equal to 255.');
        }
     ...
     * Sets value
     *
     * @param string $value Configuration of the rule, as it is stored by the Connect or the Forge app on the rule configuration page.
     *
     * @return self
     */
