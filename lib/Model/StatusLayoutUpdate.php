...
/**
 * StatusLayoutUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class StatusLayoutUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusLayoutUpdate';
    ...
    protected static $openAPITypes = [
        'layout' => '\OpenAPI\Client\Model\WorkflowLayout',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status_reference'] === null) {
            $invalidProperties[] = "'status_reference' can't be null";
        }
     ...
     * Sets layout
     *
     * @param \OpenAPI\Client\Model\WorkflowLayout|null $layout layout
     *
     * @return self
     */
     ...
     * Sets properties
     *
     * @param array<string,string> $properties The properties for this status layout.
     *
     * @return self
     */
     ...
     *
     * @param string $status_reference A unique ID which the status will use to refer to this layout configuration.
     *
     * @return self
     */
