...
/**
 * ProjectIssueTypes Class Doc Comment
 *
 * @category Class
 ...
 */
class ProjectIssueTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectIssueTypes';
    ...
    protected static $openAPITypes = [
        'issue_types' => 'string[]',
        'project' => '\OpenAPI\Client\Model\ProjectId'
    ];
    ...
    */
     ...
     * Sets issue_types
     *
     * @param string[]|null $issue_types IDs of the issue types
     *
     * @return self
     */
    public function setIssueTypes($issue_types)
    {
        ...
        if (is_null($issue_types)) {
            array_push($this->openAPINullablesSetToNull, 'issue_types');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('issue_types', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets project
     *
     * @return \OpenAPI\Client\Model\ProjectId|null
     */
     ...
     * Sets project
     *
     * @param \OpenAPI\Client\Model\ProjectId|null $project project
     *
     * @return self
     */
