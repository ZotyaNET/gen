 ...
 */
class DefaultWorkflow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DefaultWorkflow';
    ...
    */
     ...
     *
     * @param bool|null $update_draft_if_needed Whether a draft workflow scheme is created or updated when updating an active workflow scheme. The draft is updated with the new default workflow. Defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets workflow
     *
     * @param string $workflow The name of the workflow to set as the default workflow.
     *
     * @return self
     */
