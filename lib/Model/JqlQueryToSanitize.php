...
/**
 * JqlQueryToSanitize Class Doc Comment
 *
 * @category Class
 ...
 */
class JqlQueryToSanitize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JqlQueryToSanitize';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling JqlQueryToSanitize., must be smaller than or equal to 128.');
        }
