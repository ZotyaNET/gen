...
/**
 * PageBeanWorkflow Class Doc Comment
 *
 * @category Class
 ...
 */
class PageBeanWorkflow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageBeanWorkflow';
    ...
    protected static $openAPITypes = [
        ...
        'start_at' => 'int',
        'total' => 'int',
        'values' => '\OpenAPI\Client\Model\Workflow[]'
    ];
    ...
    */
     ...
     * Sets values
     *
     * @param \OpenAPI\Client\Model\Workflow[]|null $values The list of items.
     *
     * @return self
     */
