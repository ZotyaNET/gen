...
/**
 * ConditionGroupConfiguration Class Doc Comment
 *
 * @category Class
 ...
 */
class ConditionGroupConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConditionGroupConfiguration';
    ...
    protected static $openAPITypes = [
        'condition_groups' => '\OpenAPI\Client\Model\ConditionGroupConfiguration[]',
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\ConditionGroupConfiguration[]|null $condition_groups The nested conditions of the condition group.
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string|null $operation Determines how the conditions in the group are evaluated. Accepts either `ANY` or `ALL`. If `ANY` is used, at least one condition in the group must be true for the group to evaluate to true. If `ALL` is used, all conditions in the group must be true for the group to evaluate to true.
     *
     * @return self
     */
