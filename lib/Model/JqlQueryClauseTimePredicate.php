...
/**
 * JqlQueryClauseTimePredicate Class Doc Comment
 *
 * @category Class
 ...
 */
class JqlQueryClauseTimePredicate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JqlQueryClauseTimePredicate';
    ...
    public const OPERATOR_DURING = 'during';
    public const OPERATOR_BY = 'by';
    ...
    */
     ...
     * Sets operator
     *
     * @param string $operator The operator between the field and the operand.
     *
     * @return self
     */
