...
/**
 * WorkflowOperations Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowOperations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowOperations';
    ...
    */
     ...
     * Sets can_delete
     *
     * @param bool $can_delete Whether the workflow can be deleted.
     *
     * @return self
     */
     ...
     * Sets can_edit
     *
     * @param bool $can_edit Whether the workflow can be updated.
     *
     * @return self
     */
