...
/**
 * WorklogUpdateAuthor Class Doc Comment
 *
 * @category Class
 ...
 */
class WorklogUpdateAuthor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Worklog_updateAuthor';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling WorklogUpdateAuthor., must be smaller than or equal to 128.');
        }
