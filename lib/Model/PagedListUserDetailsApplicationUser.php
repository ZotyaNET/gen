...
/**
 * PagedListUserDetailsApplicationUser Class Doc Comment
 *
 * @category Class
 ...
 */
class PagedListUserDetailsApplicationUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PagedListUserDetailsApplicationUser';
    ...
    protected static $openAPITypes = [
        'end_index' => 'int',
        'items' => '\OpenAPI\Client\Model\UserDetails[]',
        'max_results' => 'int',
        'size' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\UserDetails[]|null $items The list of items.
     *
     * @return self
     */
