...
/**
 * PageOfDashboards Class Doc Comment
 *
 * @category Class
 ...
 */
class PageOfDashboards implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageOfDashboards';
    ...
    protected static $openAPITypes = [
        'dashboards' => '\OpenAPI\Client\Model\Dashboard[]',
        'max_results' => 'int',
        'next' => 'string',
        'prev' => 'string',
        'start_at' => 'int',
    ...
    */
     ...
     * Gets dashboards
     *
     * @return \OpenAPI\Client\Model\Dashboard[]|null
     */
     ...
     * Sets dashboards
     *
     * @param \OpenAPI\Client\Model\Dashboard[]|null $dashboards List of dashboards.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string|null $next The URL of the next page of results, if any.
     *
     * @return self
     */
     ...
     * Sets prev
     *
     * @param string|null $prev The URL of the previous page of results, if any.
     *
     * @return self
     */
