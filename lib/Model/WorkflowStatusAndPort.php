...
/**
 * WorkflowStatusAndPort Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowStatusAndPort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowStatusAndPort';
    ...
    */
     ...
     * Sets port
     *
     * @param int|null $port The port the transition is connected to this status.
     *
     * @return self
     */
     ...
     *
     * @param string|null $status_reference The reference of this status.
     *
     * @return self
     */
