...
/**
 * FilterSubscriptionsList Class Doc Comment
 *
 * @category Class
 ...
 */
class FilterSubscriptionsList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilterSubscriptionsList';
    ...
    protected static $openAPITypes = [
        'end_index' => 'int',
        'items' => '\OpenAPI\Client\Model\FilterSubscription[]',
        'max_results' => 'int',
        'size' => 'int',
        'start_index' => 'int'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\FilterSubscription[]|null $items The list of items.
     *
     * @return self
     */
