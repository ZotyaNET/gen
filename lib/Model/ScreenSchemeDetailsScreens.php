...
/**
 * ScreenSchemeDetailsScreens Class Doc Comment
 *
 * @category Class
 ...
 */
class ScreenSchemeDetailsScreens implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreenSchemeDetails_screens';
    ...
    */
     ...
     * Sets create
     *
     * @param int|null $create The ID of the create screen.
     *
     * @return self
     */
     ...
     * Sets default
     *
     * @param int|null $default The ID of the default screen. Required when creating a screen scheme.
     *
     * @return self
     */
     ...
     * Sets edit
     *
     * @param int|null $edit The ID of the edit screen.
     *
     * @return self
     */
     ...
     * Sets view
     *
     * @param int|null $view The ID of the view screen.
     *
     * @return self
     */
