...
/**
 * ProjectScopeBean Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectScopeBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectScopeBean';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the project that the option's behavior applies to.
     *
     * @return self
     */
