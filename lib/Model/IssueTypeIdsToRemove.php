...
/**
 * IssueTypeIdsToRemove Class Doc Comment
 *
 * @category Class
 ...
 */
class IssueTypeIdsToRemove implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTypeIdsToRemove';
    ...
    */
     ...
     * Sets issue_type_ids
     *
     * @param string[] $issue_type_ids The list of issue type IDs. Must contain unique values not longer than 255 characters and not be empty. Maximum of 100 IDs.
     *
     * @return self
     */
