...
class SearchResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'expand' => 'string',
        'issues' => '\OpenAPI\Client\Model\IssueBean[]',
        'max_results' => 'int',
    ...
    */
     ...
     * Sets expand
     *
     * @param string|null $expand Expand options that include additional search result details in the response.
     *
     * @return self
     */
     ...
     * Gets issues
     *
     * @return \OpenAPI\Client\Model\IssueBean[]|null
     */
     ...
     * Sets issues
     *
     * @param \OpenAPI\Client\Model\IssueBean[]|null $issues The list of issues found by the search.
     *
     * @return self
     */
     ...
     * Sets names
     *
     * @param array<string,string>|null $names The ID and name of each field in the search results.
     *
     * @return self
     */
     ...
     * Sets schema
     *
     * @param array<string,\OpenAPI\Client\Model\JsonTypeBean>|null $schema The schema describing the field types in the search results.
     *
     * @return self
     */
     ...
     * Sets start_at
     *
     * @param int|null $start_at The index of the first item returned on the page.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The number of results on the page.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $warning_messages Any warnings related to the JQL query.
     *
     * @return self
     */
    public function setWarningMessages($warning_messages)
    {
        ...
        if (is_null($warning_messages)) {
            throw new \InvalidArgumentException('non-nullable warning_messages cannot be null');
        }
