...
/**
 * PageOfStatuses Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PageOfStatuses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageOfStatuses';
    ...
    protected static $openAPITypes = [
        ...
        'start_at' => 'int',
        'total' => 'int',
        'values' => '\OpenAPI\Client\Model\JiraStatus[]'
    ];
    ...
    */
     ...
     * Sets next_page
     *
     * @param string|null $next_page The URL of the next page of results, if any.
     *
     * @return self
     */
     ...
     * Sets self
     *
     * @param string|null $self The URL of this page.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total Number of items that satisfy the search.
     *
     * @return self
     */
     ...
     * Gets values
     *
     * @return \OpenAPI\Client\Model\JiraStatus[]|null
     */
     ...
     * Sets values
     *
     * @param \OpenAPI\Client\Model\JiraStatus[]|null $values The list of items.
     *
     * @return self
     */
