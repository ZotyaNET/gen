...
/**
 * IssueTypeInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class IssueTypeInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTypeInfo';
    ...
    */
     ...
     * Sets avatar_id
     *
     * @param int|null $avatar_id The avatar of the issue type.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id The ID of the issue type.
     *
     * @return self
     */
