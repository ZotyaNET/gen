...
/**
 * StatusReferenceAndPort Class Doc Comment
 *
 * @category Class
 ...
 */
class StatusReferenceAndPort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusReferenceAndPort';
    ...
    */
     ...
     * Sets port
     *
     * @param int|null $port The port this transition uses to connect to this status.
     *
     * @return self
     */
     ...
     *
     * @param string $status_reference The reference of this status.
     *
     * @return self
     */
