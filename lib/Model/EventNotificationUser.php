...
/**
 * EventNotificationUser Class Doc Comment
 *
 * @category Class
 ...
 */
class EventNotificationUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventNotification_user';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling EventNotificationUser., must be smaller than or equal to 128.');
        }
