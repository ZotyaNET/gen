...
/**
 * ComponentWithIssueCountLead Class Doc Comment
 *
 * @category Class
 ...
 */
class ComponentWithIssueCountLead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ComponentWithIssueCount_lead';
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling ComponentWithIssueCountLead., must be smaller than or equal to 128.');
        }
