...
/**
 * NotificationSchemeNotificationDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationSchemeNotificationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationSchemeNotificationDetails';
    ...
    */
     ...
     *
     * @param string $notification_type The notification type, e.g `CurrentAssignee`, `Group`, `EmailAddress`.
     *
     * @return self
     */
     ...
     * Sets parameter
     *
     * @param string|null $parameter The value corresponding to the specified notification type.
     *
     * @return self
     */
