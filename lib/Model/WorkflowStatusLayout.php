...
/**
 * WorkflowStatusLayout Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowStatusLayout implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowStatusLayout';
    ...
    */
     ...
     * Sets x
     *
     * @param float|null $x The x axis location.
     *
     * @return self
     */
     ...
     * Sets y
     *
     * @param float|null $y The y axis location.
     *
     * @return self
     */
