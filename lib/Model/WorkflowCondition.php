...
/**
 * WorkflowCondition Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'node_type';
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowCondition';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['node_type'] = static::$openAPIModelName;
    }
    ...
    */
     ...
     * Sets configuration
     *
     * @param object|null $configuration EXPERIMENTAL. The configuration of the transition rule.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type The type of the transition rule.
     *
     * @return self
     */
