...
/**
 * PaginatedResponseComment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedResponseComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedResponseComment';
    ...
    protected static $openAPITypes = [
        'max_results' => 'int',
        'results' => '\OpenAPI\Client\Model\Comment[]',
        'start_at' => 'int',
        'total' => 'int'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\Comment[]|null $results results
     *
     * @return self
     */
