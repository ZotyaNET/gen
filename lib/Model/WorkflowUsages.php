...
/**
 * WorkflowUsages Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowUsages implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowUsages';
    ...
    */
     ...
     * Sets workflow_id
     *
     * @param string|null $workflow_id Workflow ID.
     *
     * @return self
     */
     ...
     * Sets workflow_name
     *
     * @param string|null $workflow_name Workflow name.
     *
     * @return self
     */
