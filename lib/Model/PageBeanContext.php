...
/**
 * PageBeanContext Class Doc Comment
 *
 * @category Class
 ...
 */
class PageBeanContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PageBeanContext';
    ...
    protected static $openAPITypes = [
        ...
        'start_at' => 'int',
        'total' => 'int',
        'values' => '\OpenAPI\Client\Model\Context[]'
    ];
    ...
    */
     ...
     * Sets values
     *
     * @param \OpenAPI\Client\Model\Context[]|null $values The list of items.
     *
     * @return self
     */
