...
/**
 * IssueTypesWorkflowMapping Class Doc Comment
 *
 * @category Class
 ...
 */
class IssueTypesWorkflowMapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTypesWorkflowMapping';
    ...
    {
        $this->setIfExists('default_mapping', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $default_mapping Whether the workflow is the default workflow for the workflow scheme.
     *
     * @return self
     */
    public function setDefaultMapping($default_mapping)
    {
        ...
        if (is_null($default_mapping)) {
            throw new \InvalidArgumentException('non-nullable default_mapping cannot be null');
        }
     ...
     * Sets issue_types
     *
     * @param string[]|null $issue_types The list of issue type IDs.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $update_draft_if_needed Whether a draft workflow scheme is created or updated when updating an active workflow scheme. The draft is updated with the new workflow-issue types mapping. Defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets workflow
     *
     * @param string|null $workflow The name of the workflow. Optional if updating the workflow-issue types mapping.
     *
     * @return self
     */
