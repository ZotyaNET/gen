...
/**
 * ProjectComponent Class Doc Comment
 *
 * @category Class
 ...
 */
class ProjectComponent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectComponent';
    ...
    protected static $openAPITypes = [
        'assignee' => '\OpenAPI\Client\Model\ProjectComponentAssignee',
        'assignee_type' => 'string',
        'description' => 'string',
        'id' => 'string',
        'is_assignee_type_valid' => 'bool',
        'lead' => '\OpenAPI\Client\Model\ProjectComponentLead',
        'lead_account_id' => 'string',
        'lead_user_name' => 'string',
        'name' => 'string',
        'project' => 'string',
        'project_id' => 'int',
        'real_assignee' => '\OpenAPI\Client\Model\ProjectComponentRealAssignee',
    ...
    protected static $setters = [
        ...
        'lead_user_name' => 'setLeadUserName',
        'name' => 'setName',
        'project' => 'setProject',
    ...
    protected static $getters = [
        ...
        'lead_user_name' => 'getLeadUserName',
        'name' => 'getName',
        'project' => 'getProject',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lead_user_name', $data ?? [], null);
    ...
    */
     ...
     * Gets assignee
     *
     * @return \OpenAPI\Client\Model\ProjectComponentAssignee|null
     */
     ...
     * Sets assignee
     *
     * @param \OpenAPI\Client\Model\ProjectComponentAssignee|null $assignee assignee
     *
     * @return self
     */
     ...
     * Sets assignee_type
     *
     * @param string|null $assignee_type The nominal user type used to determine the assignee for issues created with this component. See `realAssigneeType` for details on how the type of the user, and hence the user, assigned to issues is determined. Can take the following values:   *  `PROJECT_LEAD` the assignee to any issues created with this component is nominally the lead for the project the component is in.  *  `COMPONENT_LEAD` the assignee to any issues created with this component is nominally the lead for the component.  *  `UNASSIGNED` an assignee is not set for issues created with this component.  *  `PROJECT_DEFAULT` the assignee to any issues created with this component is nominally the default assignee for the project that the component is in.  Default value: `PROJECT_DEFAULT`.   Optional when creating or updating a component.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The description for the component. Optional when creating or updating a component.
     *
     * @return self
     */
     ...
     * Gets lead
     *
     * @return \OpenAPI\Client\Model\ProjectComponentLead|null
     */
     ...
     * Sets lead
     *
     * @param \OpenAPI\Client\Model\ProjectComponentLead|null $lead lead
     *
     * @return self
     */
     ...
     *
     * @param string|null $lead_account_id The accountId of the component's lead user. The accountId uniquely identifies the user across all Atlassian products. For example, *5b10ac8d82e05b22cc7d4ef5*.
     *
     * @return self
     */
    public function setLeadAccountId($lead_account_id)
    {
        if (!is_null($lead_account_id) && (mb_strlen($lead_account_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $lead_account_id when calling ProjectComponent., must be smaller than or equal to 128.');
        }
    ...
    {
        return $this->container['lead_user_name'];
    }

    /**
     * Sets lead_user_name
     *
     * @param string|null $lead_user_name This property is no longer available and will be removed from the documentation soon. See the [deprecation notice](https://developer.atlassian.com/cloud/jira/platform/deprecation-notice-user-privacy-api-migration-guide/) for details.
     *
     * @return self
     */
    public function setLeadUserName($lead_user_name)
    {

        if (is_null($lead_user_name)) {
            throw new \InvalidArgumentException('non-nullable lead_user_name cannot be null');
        }

        $this->container['lead_user_name'] = $lead_user_name;
     ...
     * Sets name
     *
     * @param string|null $name The unique name for the component in the project. Required when creating a component. Optional when updating a component. The maximum length is 255 characters.
     *
     * @return self
     */
     ...
     * Sets project
     *
     * @param string|null $project The key of the project the component is assigned to. Required when creating a component. Can't be updated.
     *
     * @return self
     */
     ...
     * Sets project_id
     *
     * @param int|null $project_id The ID of the project the component is assigned to.
     *
     * @return self
     */
     ...
     * Gets real_assignee
     *
     * @return \OpenAPI\Client\Model\ProjectComponentRealAssignee|null
     */
     ...
     * Sets real_assignee
     *
     * @param \OpenAPI\Client\Model\ProjectComponentRealAssignee|null $real_assignee real_assignee
     *
     * @return self
     */
     ...
     * Sets self
     *
     * @param string|null $self The URL of the component.
     *
     * @return self
     */
