...
/**
 * IssueTypeUpdateBean Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IssueTypeUpdateBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTypeUpdateBean';
    ...
    */
     ...
     * Sets avatar_id
     *
     * @param int|null $avatar_id The ID of an issue type avatar.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The unique name for the issue type. The maximum length is 60 characters.
     *
     * @return self
     */
