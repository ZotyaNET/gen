...
/**
 * CreateCustomFieldContext Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateCustomFieldContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCustomFieldContext';
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description The description of the context.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the context.
     *
     * @return self
     */
     ...
     * Sets issue_type_ids
     *
     * @param string[]|null $issue_type_ids The list of issue types IDs for the context. If the list is empty, the context refers to all issue types.
     *
     * @return self
     */
     ...
     * Sets project_ids
     *
     * @param string[]|null $project_ids The list of project IDs associated with the context. If the list is empty, the context is global.
     *
     * @return self
     */
