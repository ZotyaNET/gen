 ...
 */
class Transitions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Transitions';
    ...
    */
     ...
     * Sets expand
     *
     * @param string|null $expand Expand options that include additional transitions details in the response.
     *
     * @return self
     */
     ...
     * Sets transitions
     *
     * @param \OpenAPI\Client\Model\IssueTransition[]|null $transitions List of issue transitions.
     *
     * @return self
     */
