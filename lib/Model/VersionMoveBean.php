...
/**
 * VersionMoveBean Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VersionMoveBean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VersionMoveBean';
    ...
    */
     ...
     * Sets after
     *
     * @param string|null $after The URL (self link) of the version after which to place the moved version. Cannot be used with `position`.
     *
     * @return self
     */
     ...
     * Sets position
     *
     * @param string|null $position An absolute position in which to place the moved version. Cannot be used with `after`.
     *
     * @return self
     */
