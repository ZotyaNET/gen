...
/**
 * WorkflowTransitions Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowTransitions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowTransitions';
    ...
    protected static $openAPITypes = [
        ...
        'conditions' => '\OpenAPI\Client\Model\ConditionGroupConfiguration',
        'custom_issue_event_id' => 'string',
        'description' => 'string',
        'from' => '\OpenAPI\Client\Model\WorkflowStatusAndPort[]',
        'id' => 'string',
        'name' => 'string',
        'properties' => 'array<string,string>',
        'to' => '\OpenAPI\Client\Model\WorkflowStatusAndPort',
    ...
    */
     ...
     * Gets conditions
     *
     * @return \OpenAPI\Client\Model\ConditionGroupConfiguration|null
     */
     ...
     * Sets conditions
     *
     * @param \OpenAPI\Client\Model\ConditionGroupConfiguration|null $conditions conditions
     *
     * @return self
     */
    ...
    public function setCustomIssueEventId($custom_issue_event_id)
    {
        ...
        if (is_null($custom_issue_event_id)) {
            array_push($this->openAPINullablesSetToNull, 'custom_issue_event_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_issue_event_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets from
     *
     * @return \OpenAPI\Client\Model\WorkflowStatusAndPort[]|null
     */
     ...
     * Sets from
     *
     * @param \OpenAPI\Client\Model\WorkflowStatusAndPort[]|null $from The statuses the transition can start from.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id The ID of the transition.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of the transition.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \OpenAPI\Client\Model\WorkflowStatusAndPort|null $to to
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The transition type.
     *
     * @return self
     */
