...
/**
 * CustomFieldContextOption Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomFieldContextOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldContextOption';
    ...
    */
     ...
     * Sets option_id
     *
     * @param string|null $option_id For cascading options, the ID of the custom field option containing the cascading option.
     *
     * @return self
     */
