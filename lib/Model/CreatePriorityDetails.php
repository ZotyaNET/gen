...
/**
 * CreatePriorityDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePriorityDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePriorityDetails';
    ...
    */
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreatePriorityDetails., must be smaller than or equal to 255.');
        }
    ...
    public function setIconUrl($icon_url)
    {
        ...
        if (!is_null($icon_url) && (mb_strlen($icon_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $icon_url when calling CreatePriorityDetails., must be smaller than or equal to 255.');
        }
     ...
     * Sets name
     *
     * @param string $name The name of the priority. Must be unique.
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePriorityDetails., must be smaller than or equal to 60.');
        }
     ...
     * Sets status_color
     *
     * @param string $status_color The status color of the priority in 3-digit or 6-digit hexadecimal format.
     *
     * @return self
     */
