...
/**
 * StatusCreate Class Doc Comment
 *
 * @category Class
 ...
 */
class StatusCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatusCreate';
    ...
    */
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StatusCreate., must be smaller than or equal to 255.');
        }
