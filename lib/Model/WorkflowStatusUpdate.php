...
/**
 * WorkflowStatusUpdate Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkflowStatusUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowStatusUpdate';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['status_category'] === null) {
            $invalidProperties[] = "'status_category' can't be null";
        }
     ...
     *
     * @param string $status_category The category of the status.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getStatusCategoryAllowableValues();
        if (!in_array($status_category, $allowedValues, true)) {
     ...
     *
     * @param string $status_reference The reference of the status.
     *
     * @return self
     */
